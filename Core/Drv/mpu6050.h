...
typedef struct acc {
    ...
    float offsetRaw[3];     /* Store raw offset value for gyro */
...
typedef struct gyro {
    ...
    float dps[3];           /*Store RAW DPS of 3 axises*/

    float dpsX;             /*Store filtered DPS of X-axis*/
    float dpsY;             /*Store filtered DPS of Y-axis*/
    float dpsZ;             /*Store filtered DPS of Z-axis*/
